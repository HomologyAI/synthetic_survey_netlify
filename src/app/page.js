...
import response from "./data/None_1004_202506181444_lotus_big_new1profile3_60000summary_addprice_100_fix_failover_20_gemini-2.5-pro-preview-05-06_gemini-2.5-flash-preview-05-20.json";
...
const SyntheticSurveyPageContainer = () => {
  ...
  .comments-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 8px; margin-top: 15px; }
  ...
  @media (max-width: 768px) { .report-section { grid-template-columns: 1fr; } .pie-chart-container, .full-width-container { grid-column: 1 / -1; } .comments-grid { grid-template-columns: 1fr; } }
